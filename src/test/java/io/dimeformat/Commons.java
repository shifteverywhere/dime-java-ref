...
public class Commons {
    ...
    // -- TRUSTED IDENTITY ---
    private static final String _encodedTrustedKey = "Di/1j:KEY.";
    private static final String _encodedTrustedIdentity = "Di/1j:ID..3vSy48X6SrRI2O4JpT2kxh7MRF0jNSiHlg3ON+mfnvSFwKaxr+E4rkycJqizXeNtto/AerHG326M7AHFWkygBw";
    private static Key _trustedKey;
    private static Identity _trustedIdentity;

    // -- INTERMEDIATE IDENTITY --
    private static final String _encodedIntermediateKey = "Di/1j:KEY.";
    private static final String _encodedIntermediateIdentity = "Di/1j:ID..c81T+ChTK7TWj/fC0TMB+N1dwTTEUIoMeAAE5PyGLuK1lm8dgVyYQPNtSxurcvY9rlfMNgzhQAkguSnn8vBuBw";
    private static Key _intermediateKey;
    private static Identity _intermediateIdentity;

    // -- ISSUER IDENTITY (SENDER) --
    private static final String _encodedIssuerKey = "Di/1j:KEY.";
    public static final String _encodedIssuerIdentity = "Di/1j:ID...vzjmxBAyp2HX3RlWydjGRWsCLOojiXPZQOwEcdcSf+fVq9yWjHkNmJWjsQfxS0El4fDu7WdBidkdNMD7zhgGCw";
    private static Key _issuerKey;
    private static Identity _issuerIdentity;

    // -- AUDIENCE IDENTITY (RECEIVER) --
    private static final String _encodedAudienceKey = "Di/1j:KEY.";
    private static String _encodedAudienceIdentity = "Di/1j:ID...5s809nG0pQnFRnOSsDmSRzs3OLVNGrbgu+8o0HTuBFhw2GyVnYkHzSOIxQClDDZcuky530r/6TBHy78AxroDCg";
